...
public class AuthenticationController {
    ...
    public String login(@PathParam("email")String emailInput, @PathParam("password")String passwordInput) throws IOException {
        try {
            ...
            // Try to get the member of the database by providing the eMail and password as parameter
